...
func (tr *License) GetObservation() (map[string]interface{}, error) {
...
func (tr *License) SetObservation(obs map[string]interface{}) error {
...
func (tr *License) GetParameters() (map[string]interface{}, error) {
...
func (tr *License) SetParameters(params map[string]interface{}) error {
