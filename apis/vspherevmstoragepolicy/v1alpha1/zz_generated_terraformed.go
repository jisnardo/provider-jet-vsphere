...
func (tr *StoragePolicy) GetObservation() (map[string]interface{}, error) {
...
func (tr *StoragePolicy) SetObservation(obs map[string]interface{}) error {
...
func (tr *StoragePolicy) GetParameters() (map[string]interface{}, error) {
...
func (tr *StoragePolicy) SetParameters(params map[string]interface{}) error {
