...
func (tr *HostOverride) GetObservation() (map[string]interface{}, error) {
...
func (tr *HostOverride) SetObservation(obs map[string]interface{}) error {
...
func (tr *HostOverride) GetParameters() (map[string]interface{}, error) {
...
func (tr *HostOverride) SetParameters(params map[string]interface{}) error {
