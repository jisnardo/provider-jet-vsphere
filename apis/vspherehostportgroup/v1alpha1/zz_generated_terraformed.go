...
func (tr *PortGroup) GetObservation() (map[string]interface{}, error) {
...
func (tr *PortGroup) SetObservation(obs map[string]interface{}) error {
...
func (tr *PortGroup) GetParameters() (map[string]interface{}, error) {
...
func (tr *PortGroup) SetParameters(params map[string]interface{}) error {
