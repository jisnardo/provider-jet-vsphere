...
func (tr *Attribute) GetObservation() (map[string]interface{}, error) {
...
func (tr *Attribute) SetObservation(obs map[string]interface{}) error {
...
func (tr *Attribute) GetParameters() (map[string]interface{}, error) {
...
func (tr *Attribute) SetParameters(params map[string]interface{}) error {
