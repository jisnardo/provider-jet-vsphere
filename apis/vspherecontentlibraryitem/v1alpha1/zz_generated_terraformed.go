...
func (tr *LibraryItem) GetObservation() (map[string]interface{}, error) {
...
func (tr *LibraryItem) SetObservation(obs map[string]interface{}) error {
...
func (tr *LibraryItem) GetParameters() (map[string]interface{}, error) {
...
func (tr *LibraryItem) SetParameters(params map[string]interface{}) error {
