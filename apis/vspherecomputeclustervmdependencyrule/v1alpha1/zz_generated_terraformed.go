...
func (tr *ClusterVMDependencyRule) GetObservation() (map[string]interface{}, error) {
...
func (tr *ClusterVMDependencyRule) SetObservation(obs map[string]interface{}) error {
...
func (tr *ClusterVMDependencyRule) GetParameters() (map[string]interface{}, error) {
...
func (tr *ClusterVMDependencyRule) SetParameters(params map[string]interface{}) error {
