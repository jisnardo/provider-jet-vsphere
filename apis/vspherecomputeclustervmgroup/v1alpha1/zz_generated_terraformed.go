...
func (tr *ClusterVMGroup) GetObservation() (map[string]interface{}, error) {
...
func (tr *ClusterVMGroup) SetObservation(obs map[string]interface{}) error {
...
func (tr *ClusterVMGroup) GetParameters() (map[string]interface{}, error) {
...
func (tr *ClusterVMGroup) SetParameters(params map[string]interface{}) error {
