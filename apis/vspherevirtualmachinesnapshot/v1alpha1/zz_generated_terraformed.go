...
func (tr *MachineSnapshot) GetObservation() (map[string]interface{}, error) {
...
func (tr *MachineSnapshot) SetObservation(obs map[string]interface{}) error {
...
func (tr *MachineSnapshot) GetParameters() (map[string]interface{}, error) {
...
func (tr *MachineSnapshot) SetParameters(params map[string]interface{}) error {
