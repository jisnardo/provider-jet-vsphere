...
func (tr *Library) GetObservation() (map[string]interface{}, error) {
...
func (tr *Library) SetObservation(obs map[string]interface{}) error {
...
func (tr *Library) GetParameters() (map[string]interface{}, error) {
...
func (tr *Library) SetParameters(params map[string]interface{}) error {
