...
func (tr *VMOverride) GetObservation() (map[string]interface{}, error) {
...
func (tr *VMOverride) SetObservation(obs map[string]interface{}) error {
...
func (tr *VMOverride) GetParameters() (map[string]interface{}, error) {
...
func (tr *VMOverride) SetParameters(params map[string]interface{}) error {
