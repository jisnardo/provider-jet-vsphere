...
func (tr *ClusterHostGroup) GetObservation() (map[string]interface{}, error) {
...
func (tr *ClusterHostGroup) SetObservation(obs map[string]interface{}) error {
...
func (tr *ClusterHostGroup) GetParameters() (map[string]interface{}, error) {
...
func (tr *ClusterHostGroup) SetParameters(params map[string]interface{}) error {
