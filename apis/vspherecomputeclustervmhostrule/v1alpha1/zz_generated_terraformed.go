...
func (tr *ClusterVMHostRule) GetObservation() (map[string]interface{}, error) {
...
func (tr *ClusterVMHostRule) SetObservation(obs map[string]interface{}) error {
...
func (tr *ClusterVMHostRule) GetParameters() (map[string]interface{}, error) {
...
func (tr *ClusterVMHostRule) SetParameters(params map[string]interface{}) error {
