...
func (tr *VirtualSwitch) GetObservation() (map[string]interface{}, error) {
...
func (tr *VirtualSwitch) SetObservation(obs map[string]interface{}) error {
...
func (tr *VirtualSwitch) GetParameters() (map[string]interface{}, error) {
...
func (tr *VirtualSwitch) SetParameters(params map[string]interface{}) error {
