...
func (tr *Category) GetObservation() (map[string]interface{}, error) {
...
func (tr *Category) SetObservation(obs map[string]interface{}) error {
...
func (tr *Category) GetParameters() (map[string]interface{}, error) {
...
func (tr *Category) SetParameters(params map[string]interface{}) error {
