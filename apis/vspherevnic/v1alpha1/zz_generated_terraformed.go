...
func (tr *Vnic) GetObservation() (map[string]interface{}, error) {
...
func (tr *Vnic) SetObservation(obs map[string]interface{}) error {
...
func (tr *Vnic) GetParameters() (map[string]interface{}, error) {
...
func (tr *Vnic) SetParameters(params map[string]interface{}) error {
