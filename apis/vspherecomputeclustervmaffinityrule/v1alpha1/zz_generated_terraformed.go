...
func (tr *ClusterVMAffinityRule) GetObservation() (map[string]interface{}, error) {
...
func (tr *ClusterVMAffinityRule) SetObservation(obs map[string]interface{}) error {
...
func (tr *ClusterVMAffinityRule) GetParameters() (map[string]interface{}, error) {
...
func (tr *ClusterVMAffinityRule) SetParameters(params map[string]interface{}) error {
